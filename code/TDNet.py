    ...
    def Run(self):
        ...
        if self.cfg['Visualizer']['1/0']:
            ...
            if self.cfg['Visualizer']['Main Stream']['1/0']:
                if self.cfg['Visualizer']['Main Stream']['Video']:     Videos['Main'] = cv2.VideoWriter(self.OutVideo + f'/TDNet - Main - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.CameraSize)
                if self.cfg['Visualizer']['Main Stream']['VideoBEV']:  Videos['MainBEV'] = cv2.VideoWriter(self.OutVideo + f'/TDNet - Main BEV - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.CameraSize)
            if self.cfg['Visualizer']['2D Detection']['1/0']:
                if self.cfg['Visualizer']['2D Detection']['Video']:    Videos['2D']   = cv2.VideoWriter(self.OutVideo + f'/TDNet - Detection 2D- [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.CameraSize)
            if self.cfg['Visualizer']['3D Detection']['1/0']:
                if self.cfg['Visualizer']['3D Detection']['Video']:    Videos['3D']   = cv2.VideoWriter(self.OutVideo + f'/TDNet - Detection 3D - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.CameraSize)
            if self.cfg['Visualizer']['Environment Map']['1/0']:
                if self.cfg['Visualizer']['Environment Map']['Video']: Videos['Env']  = cv2.VideoWriter(self.OutVideo + f'/TDNet - Environment Map - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.BevSize)
        ...
        if self.cfg['Figure']['1/0']:
            if self.cfg['Figure']['Counter']:
                ...
                if self.cfg['Figure']['Counter']['Video']:
                    Videos['Cont']  = cv2.VideoWriter(self.OutVideo + f'/TDNet - Figure of Counters - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, (self.cfg['Figure']['Counter']['Size'][0]*100, self.cfg['Figure']['Counter']['Size'][1]*100))
            if self.cfg['Figure']['AVGSpeed']:
                ...
                if self.cfg['Figure']['AVGSpeed']['Video']: 
                    Videos['AVGS']  = cv2.VideoWriter(self.OutVideo + f'/TDNet - Figure of Average Speed - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, (self.cfg['Figure']['AVGSpeed']['Size'][0]*100, self.cfg['Figure']['AVGSpeed']['Size'][1]*100))

        if self.cfg['Heatmap']['1/0']:
            Heatmaps = dict()
            if self.cfg['Heatmap']['Vehicle']['1/0']:
                if self.cfg['Heatmap']['Vehicle']['Video']:    Videos['HeatV']     = cv2.VideoWriter(self.OutVideo + f'/TDNet - Heatmap Vehicle Movements - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.RoiSize)
                if self.cfg['Heatmap']['Vehicle']['VideoBEV']: Videos['HeatV_BEV'] = cv2.VideoWriter(self.OutVideo + f'/TDNet - Heatmap Vehicle Movements BEV - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.BevSize)
            ...
            if self.cfg['Heatmap']['Pedest']['1/0']:
                if self.cfg['Heatmap']['Pedest']['Video']:     Videos['HeatP']     = cv2.VideoWriter(self.OutVideo + f'/TDNet - Heatmap Pedestrian Movements - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.RoiSize)
                if self.cfg['Heatmap']['Pedest']['VideoBEV']:  Videos['HeatP_BEV'] = cv2.VideoWriter(self.OutVideo + f'/TDNet - Heatmap Pedestrian Movements BEV - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.BevSize)
            ...
            if self.cfg['Heatmap']['Speed']['1/0']:
                if self.cfg['Heatmap']['Speed']['Video']:      Videos['HeatS']     = cv2.VideoWriter(self.OutVideo + f'/TDNet - Heatmap Vehicle Speed - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.RoiSize)
                if self.cfg['Heatmap']['Speed']['VideoBEV']:   Videos['HeatS_BEV'] = cv2.VideoWriter(self.OutVideo + f'/TDNet - Heatmap Vehicle Speed BEV - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.BevSize)
            ...
            if self.cfg['Heatmap']['Nearest']['1/0']:
                if self.cfg['Heatmap']['Nearest']['Video']:    Videos['HeatN']     = cv2.VideoWriter(self.OutVideo + f'/TDNet - Heatmap Vehicle Nearest - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.RoiSize)
                if self.cfg['Heatmap']['Nearest']['VideoBEV']: Videos['HeatN_BEV'] = cv2.VideoWriter(self.OutVideo + f'/TDNet - Heatmap Vehicle Nearest BEV - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.BevSize)
            ...
            if self.cfg['Heatmap']['Crowd']['1/0']:
                if self.cfg['Heatmap']['Crowd']['Video']:    Videos['Crowd']     = cv2.VideoWriter(self.OutVideo + f'/TDNet - Heatmap Vehicle Crowd - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.RoiSize)
                if self.cfg['Heatmap']['Crowd']['VideoBEV']: Videos['Crowd_BEV'] = cv2.VideoWriter(self.OutVideo + f'/TDNet - Heatmap Vehicle Crowd BEV - [{str(self.StartFrom)} - {str(self.EndAt)}].mp4', cv2.VideoWriter_fourcc(*self.cfg['System']['Video Format']), Stream.fps, self.BevSize)
